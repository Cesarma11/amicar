...
<table>
    <tr>
        <td>    
            <fieldset style=" margin-left:100px;  margin-top:250px; width: 500px; border:none; ">
                <h2>Permiso autobús D</h2>
                <br><br>            
                <label for=""> Para conducir un autobús necesitas obtener el permiso tipo D, que es aquel que nos permite conducir autobuses con más de 8 pasajeros, además del propio conductor/a.
                     También permite llevar un remolque con una Masa Máxima Autorizada de 750 Kg (D + E), aunque no es habitual que un autobús lleve remolque.</label>
                <br>
                <label for="" style="display:block; text-align:justify; width:500px;">Carnet D: Con el permiso D podrás conducir desde autobuses urbanos hasta autorcares que hacen trayectos largos en carreteras interurbanas, autopistas y autovías.
                </label>
                <br><br>
                <ul >
                    <li>
                        <label for="" style="display:block; text-align:justify; width:500px;" >
                            <strong>Carnet D:</strong>  Con el permiso D podrás conducir desde autobuses urbanos hasta autorcares
                    ...
                    <li>
                        <label for="" style="display:block; text-align:justify; width:500px;" >
                            <strong>Carnet D + E :</strong>Nos permite conducir los autobuses más amplios y grandes, además de permitirnos
                    ...
                    <li>
                        <label for="" style="display:block; text-align:justify; width:500px;" >
                            <strong>Permiso D1 :</strong>Permite conducir autobuses de no más de 8 metros de largo y 17 plazas, incluyendo 
                            la del conductor.  
                        </label>
                    </li>
                    <br>
                    <li>
                        <label for="" style="display:block; text-align:justify; width:500px;" >
                            <strong>Permiso D1 + E:</strong>Es igual al permiso D1, pero nos permite llevar un remolque con una MMA de 750 Kg. 
                        </label>
                    </li>
                </ul>
                <br><br>
                ...
                <td>
                    <fieldset style="margin-left:300px; width:500px; border:none; ">
                        <img src="./image/imagenAutobus.png" alt="" width="100%" style="margin-top:300px;"  >
                    </fieldset>
                </td>
                </tr>
                <tr>
